...
<template>
  <div class="yes-tabs">
    <ums-fold v-if="layout === 'common'" />
    <el-tabs
      v-model="tabActive"
      class="yes-tabs-content"
      :class="{
        ['yes-tabs-content-' + theme.tabsBarStyle]: true,
      }"
      type="card"
        ...
        <template #label>
          ...
          >
            <template v-if="theme.showTabsIcon">
              ...
              />
              <!--  如果没有图标那么取第二级的图标 -->
              <yes-icon v-else :icon="item.parentIcon" />
            </template>
            <span>
    ...
    <el-dropdown
      ...
      popper-class="yes-tabs-more-dropdown"
      @command="handleCommand"
      @visible-change="handleVisibleChange"
    >
      <span class="yes-tabs-more" :class="{ 'yes-tabs-more-active': active }">
        <span class="yes-tabs-more-icon">
          <i class="box box-t"></i>
          <i class="box box-b"></i>
        </span>
      </span>
      <template #dropdown>
        <el-dropdown-menu class="tabs-more">
          <el-dropdown-item command="closeOthersTabs">
            <yes-icon icon="close-line" />
            <span>
              {{ translateTitle('关闭其他') }}
            </span>
          </el-dropdown-item>
          <el-dropdown-item command="closeLeftTabs">
            <yes-icon icon="arrow-left-line" />
            <span>
              {{ translateTitle('关闭左侧') }}
            </span>
          </el-dropdown-item>
          <el-dropdown-item command="closeRightTabs">
            <yes-icon icon="arrow-right-line" />
            <span>
              {{ translateTitle('关闭右侧') }}
            </span>
          </el-dropdown-item>
          ...
          .el-tabs__header {
            ...
            .el-tabs__item {
              ...
              &.is-active {
                ...
                background: var(--el-color-primary-light-9);
                outline: none;
                mask: url('~@/assets/tabs_images/ums-tab.png');
                mask-size: 100% 100%;
