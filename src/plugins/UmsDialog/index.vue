<template>
  <div ref="UmsDialogRef" class="yes-dialog">
    <el-dialog
    ...
    >
      <template #title>
        ...
        <div class="yes-dialog__headerbtn">
          <button
            v-if="showFullscreen"
            ...
            @click="setFullscreen"
          >
            <yes-icon v-if="isFullscreen" icon="fullscreen-exit-line" />
            <yes-icon v-else icon="fullscreen-line" />
          </button>
          <button
            v-if="showClose"
            aria-label="close"
            ...
            @click="closeDialog"
          >
            <yes-icon icon="close-circle-line" />
          </button>
        </div>
      </template>
    ...
    setup(props) {
      ...
      watch(
        ...
        (val) => {
          ...
          if (state.dialogVisible) {
            state['umsDialogRef'].querySelector('.el-dialog').style.top = '0px'
            state['umsDialogRef'].querySelector('.el-dialog').style.left = '0px'
      ...
      const dialogdrag = () => {
        const dialogHeaderEl =
          state['umsDialogRef'].querySelector('.el-dialog__header')
        const dragDom = state['umsDialogRef'].querySelector('.el-dialog')
